...
def plot_diversity_over_timesteps_multi(runs_data):
    ...
    plt.plot(timesteps, avg_distances_ic, label='IC Average Diversity', color='orange', linewidth=2)
    plt.plot(timesteps, avg_distances_c1, label='C1 Average Diversity', color='blue', linewidth=2)
    plt.plot(timesteps, avg_distances_c2,  label='C2 Average Diversity', color='green', linewidth=2)
    plt.plot(timesteps, avg_distances, label='Average Diversity', color='purple', linewidth=2)
    plt.fill_between(timesteps, avg_distances_ic - std_distances_ic, avg_distances_ic + std_distances_ic, alpha=0.2, label='IC Std Dev', color='orange')
    plt.fill_between(timesteps, avg_distances_c1 - std_distances_c1, avg_distances_c1 + std_distances_c1, alpha=0.2, label='C1 Std Dev',  color='blue')
    plt.fill_between(timesteps, avg_distances_c2 - std_distances_c1, avg_distances_c2 + std_distances_c1, alpha=0.2, label='C2 Std Dev',  color='green')
    plt.fill_between(timesteps, avg_distances - std_distances, avg_distances + std_distances, alpha=0.2, label='Std Dev', color='purple')
